...
// Owns the real-time ECU tachometer capture, filtering and RPM diagnostics.
// This class deliberately has no dependency on the controller or logger so it
// can be injected into the sensor manager and tested independently.
class RaceSyncRpmSensor
{
public:
    bool begin();
